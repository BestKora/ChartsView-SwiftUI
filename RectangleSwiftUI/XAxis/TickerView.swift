...
struct TickerView : View {
    ...
    var rangeTime: Range<Int> {Int(userData.charts[chartIndex].lowerBound * CGFloat(numberPoints - 1))..<Int(userData.charts[chartIndex].upperBound * CGFloat(numberPoints - 1)) }
...
struct TickerView_Previews : PreviewProvider {
    static var previews: some View {
        TickerView(chart: chartsData[0], colorXAxis: Color.blue, colorXMark: Color.black, height: 40, indent: 10)
